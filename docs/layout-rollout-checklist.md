...
| Inventory (Remise) | `/remise-inventory` | `frontend/src/features/inventory/RemiseInventoryPage.tsx` | `module:remise:inventory` | `remise-inventory-dashboard`, `remise-lots` | Migrated | EditablePageLayout already applied. |
