...
export function ModulePermissionsPage() {
  ...
  const defaultLayouts = useMemo<EditableLayoutSet>(
    () => ({
      lg: [{ i: "permissions-main", x: 0, y: 0, w: 12, h: 24 }],
      md: [{ i: "permissions-main", x: 0, y: 0, w: 6, h: 24 }],
      sm: [{ i: "permissions-main", x: 0, y: 0, w: 1, h: 24 }],
      xs: [{ i: "permissions-main", x: 0, y: 0, w: 1, h: 24 }]
    }),
    []
  );
