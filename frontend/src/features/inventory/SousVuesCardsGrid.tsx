...
interface SousVuesCardsGridProps {
  ...
  onDragStart?: (event: DragEvent<HTMLButtonElement>, subviewId: string) => void;
        ...
        {subviews.map((subview) => {
          ...
          return (
            <button
              ...
              className={clsx(
                "group flex min-w-0 flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-900 dark:hover:border-slate-600",
